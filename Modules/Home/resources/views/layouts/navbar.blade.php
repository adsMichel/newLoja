...
<nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
        <a href="../../index3.html" class="navbar-brand">
            <img src="{{ asset('img/docitos.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
            ...
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                    <img src="/vendor/adminlte/dist/img/user5-128x128.jpg" class="user-image img-circle elevation-2" alt="Luiz Fernando">
                    <span class="d-none d-md-inline"> Luiz Fernando </span>
                </a>
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <li class="user-header bg-primary">
                        <img src="/vendor/adminlte/dist/img/profile.jpeg" class="img-circle elevation-2" alt="Luiz Fernando">
                    ...
                    <li class="user-footer">
                        ...
                        <form id="logout-form" action="https://sigin.df.senac.br/logout" method="POST" style="display: none;">
